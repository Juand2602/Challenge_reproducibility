...
def evolution_strategy(env_name='HalfCheetah-v4', pop_size=200, sigma=0.1, alpha=0.02, iterations=100):
    ...
    mlflow.log_artifact("/home/hadoop/MLFLOW_taller/results/paramsSwimmer-v4Para.npy")
    mlflow.log_artifact("/home/hadoop/MLFLOW_taller/results/rewardsSwimmer-v4Para.npy")
    mlflow.log_artifact("/home/hadoop/MLFLOW_taller/Swimmer-v4Para.png")
    mlflow.log_artifact("/home/hadoop/MLFLOW_taller/Swimmer-v4Para.mp4")

    return policy, reward_history

# Guardar video

def record_video(env_name, policy, video_path="/home/hadoop/MLFLOW_taller/Swimmer-v4Para.mp4"):
...
def plot_rewards(rewards):
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("/home/hadoop/MLFLOW_taller/Swimmer-v4Para.png")
    plt.show()
