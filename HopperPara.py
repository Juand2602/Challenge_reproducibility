...
def evaluate_candidate(args):
    ...
    while not done:
        ...
        prev_x = obs[0]
        penalizacion = 0
        if abs(avance_x) < 0.01:  # Umbral para considerar que está quieto
            penalizacion = 1  # Penalización por no avanzar
        total_reward += reward - penalizacion
...
if __name__ == "__main__":
    ...
    policy, rewards = evolution_strategy(env_name=env_name, pop_size=200, iterations=300)
