...
def evolution_strategy(env_name='Walker2d-v4', pop_size=200, sigma=0.05, alpha=0.01, iterations=2000):
...
def record_video(env_name, policy, video_path="C:\\Users\\Franchesco\\Desktop\\challenge\\results\\WalkerSEC.mp4"):
    env = gym.make(env_name, render_mode="rgb_array")
    obs, _ = env.reset()
...
if __name__ == "__main__":
    env_name = "Walker2d-v4"  # Puedes cambiarlo por "Hopper-v4", "Walker2d-v4", "HalfCheetah-v4", etc.
    policy, rewards = evolution_strategy(env_name=env_name, iterations=300)
